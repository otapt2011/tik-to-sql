...
// WITH DATA NORMALIZATION INTEGRATED
var TikTokExtractor = (function() {
    ...
    function extractData(jsonData, options) {
        ...
        try {
            ...
            // Step 4: AUTOMATIC NORMALIZATION (quick mode)
            if (config.normalizeData) {
                normalizeExtractedData();
            }
            
            // Step 5: Validate dates if enabled
            if (config.validateDates) {
                validateExtractedDates();
            }
            
            // Step 6: Generate SQL with proper user_id and triggers
